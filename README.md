...
установленным <a href="https://platformio.org/">PlatformIO</a>.
...
- Возможность обновления прошивки используя SD - карту.

- Возможность первоначальной прошивки платы через ST-LINK, либо по DFU протоколу через USB, переведя плату 
в режим DFU (для этого необходимо перезагрузить плату с нажатой кнопкой BOOT0).
